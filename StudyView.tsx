...
export default function StudyView() {
  ...
  useEffect(() => {
    ...
    // Parse analysisResult - could be string or structured JSON
    const resultStr = study.analysisResult || "";
    if (resultStr) {
      try {
        ...
        // Not JSON, treat as plain string (old format or invalid JSON)
        console.warn('Failed to parse analysisResult as JSON, treating as plain text:', e);
        setAnalysisResult(resultStr);
      }
    } else {
      setAnalysisResult("");
