...
async def analyze_template_form(image_url: str, template: List[dict]) -> dict:
    """Analyze image and fill template form using LLM. Returns structured JSON with fields and text."""
